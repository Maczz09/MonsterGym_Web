...
<head>
    ...
    <title>Monster Gym - The Muscle Factory</title>
...
?>
    ...
    <main>
        ...
        <div class="container-fluid fontstwo">
            <div class="row">
                <div class="col-md-12 display-1 text-light" style="text-align: center;">
                    <h1>Challenge your limits with The Muscle Factory</h1>
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 fontstwo text-light" style="text-align: center; text-emphasis-color: #515151;">
                    <h5>Desafía tus límites con The Muscle Factory</h5>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="row ">
                <div class="col-md-12 d-flex justify-content-center align-items-center img-fluid">
                    <img src="../Imagenes/HomeLogo.png" alt="HomeLogo">
                </div>
            </div>
        </div>
        ...
        <div class="container mt-4 mb-5">
            <div class="row">
                <div class="col-md d-flex">
                    <figure class="figure">
                        <img src="../Imagenes/dino.png" class="figure-img img-fluid rounded" alt="dino">
                        <figcaption class="figure-caption text-end text-light fontstwo">Nuestra
                            mascota "Dino Monster".</figcaption>
                    </figure>
                </div>
                <div class="col-md d-flex">
                    <figure class="figure">
                        <img src="../Imagenes/main1.jpg" class="figure-img img-fluid rounded" alt="ese">
                        <figcaption class="figure-caption text-end text-light fontstwo">Promoción
                            por tiempo Ilimitado.</figcaption>
                </div>
            </div>
        </div>
        ...
        <div class="container mt-4 mb-5" style="text-align: justify;">
            <div class="row">
                <div class="col-md-6 d-flex">
                    <figure class="figure">
                        <img src="../Imagenes/entrenamiento1.jpg" class="figure-img img-fluid rounded" alt="dino">
                    </figure>
                </div>
                <div class="col-md-6 text-justify text-light fontstwo">
                    <h3 class="subtittle" style="text-transform: capitalize; text-align: center;">¡Descubre
                        las Mejores Ofertas en
                        Membresías de MonsterGym en Piura!
                    </h3><br>
                    <div class>
                        <p>En MonsterGym, nos enorgullece ofrecerte no solo un lugar
                            para entrenar, sino una experiencia fitness
                            incomparable. Con nuestras membresías, obtendrás acceso a
                            instalaciones de primer nivel, clases
                            dirigidas por expertos y un ambiente motivador que te
                            impulsará a alcanzar tus metas de fitness.</p>

                        <p>
                            ¿Por qué elegir MonsterGym? Porque tenemos los mejores
                            precios en membresías y ofertas exclusivas para
                            nuestros miembros en Piura. Con una amplia gama de opciones
                            de membresía, desde acceso básico hasta
                            paquetes premium, puedes encontrar la opción perfecta que se
                            adapte a tus necesidades y presupuesto.
                        </p>

                        <p>
                            ¡No te conformes con menos! Únete a la familia de MonsterGym
                            hoy mismo y descubre por qué somos el
                            gimnasio líder en Piura. ¡Tu cuerpo, mente y espíritu te lo
                            agradecerán!
                        </p>
                        <div class="btnmg">
                            <button type="button" class="btn btn-primary"
                                onclick="window.location.href='Membresias.php'" id="membresias"
                                style="background-color: #1b1a55; border-color: #1b1a55;">
                                Redirígeme a Membresías
                            </button>
                        </div>
                    </div>
                </div>
        ...
        <div id="testimonialCarousel" class="carousel slide carousel-fade text-bg-dark fontstwo"
            ...
            <div class="carousel-bg opacity-25"></div>
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <div class="testimonial">
                        ...
                        <center>
                            <p>
                                "¡MonsterGym ha sido un punto de inflexión
                                en mi vida! Desde que
                                empecé a entrenar aquí, he ganado músculo,
                                he perdido peso y me
                                siento mejor que nunca. Los entrenadores son
                                motivadores y
                                expertos, y el ambiente es genial.
                                ¡Recomiendo encarecidamente
                                MonsterGym a cualquiera que esté buscando
                                ponerse en forma!"
                            <p> - Ana S.</p>
                ...
                <div class="carousel-item">
                    <div class="testimonial">
                        ...
                        <center>
                            <p>
                                "Nunca pensé que podría verme y sentirme así
                                de bien. Gracias a
                                MonsterGym, he alcanzado mis objetivos de
                                fitness y he ganado
                ...
                <div class="carousel-item">
                    <div class="testimonial">
                        ...
                        <center>
                            <p>
                                "MonsterGym es más que un gimnasio, es una
                                comunidad. He
                                conocido a gente estupenda aquí y me siento
                                parte de algo
                ...
                <div class="carousel-item">
                    <div class="testimonial">
                        ...
                        <center>
                            <p>
                                "MonsterGym me ha ayudado a mejorar mi salud
                                física y mental.
                                Los entrenamientos me dan un subidón de
                                energía, y el ambiente
                                positivo me ayuda a reducir el estrés. ¡Me
