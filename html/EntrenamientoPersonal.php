...
<html lang="es">
  ...
  <head>
    ...
    <title>Entrenamiento Personal - MonsterGym "The Muscle Factory"</title>
    <link
...
?>
      ...
      <main>
        <div class="container mt-4 mb-5">
          <div class="row gap-4">
            <div
              ...
              <div class="card text-bg-dark fontstwo">
                <img src="../Imagenes/entrenamientopersonal.jpg"
                ...
                <div
                  ...
                  <h1
                    class="display-4 card-title text-light text-center mb-3"><strong>ENTRENAMIENTO
        ...
        <div class="container mt-4 mb-5 ">
          <div class="row ">
            <div class="col-sm">
              <img src="../Imagenes/entrenadores.jpg" alt="Imagen de contacto"
                class="img-fluid rounded">
            </div>
            <div class="col-sm">
              <div class="d-flex flex-column text-light fontstwo">
                <br />
                <h2 class="text-justify display-3"><strong>NUESTROS
                    <br>ENTRENADORES
                    <br>PERSONALES</strong></h2>
                <p class="text-justify">
                  En MonsterGym "The muscle Factory" trabajamos
                  con Personal
                  Training altamente capacitado, por lo que puede
                  elegir entrenar
                  de la forma que mejor se adapte a sus
                  necesidades, y a su
                  presupuesto.</p>
              </div>
            </div>
        ...
        <div id="testimonialCarousel"
          class="carousel slide carousel-fade text-bg-dark fontstwo"
