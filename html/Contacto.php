...
<html lang="es">
  <head>
    ...
    <title>Contacto - MonsterGym "The Muscle Factory"</title>
    <link
          ...
          <div class="row mt-">
            ...
            <div class="col-sm">
              <div class="d-flex flex-column text-light fontstwo">
                <br />
                <h4 class="text-justify">Contáctenos</h4>
                <p class="text-justify">
                  ¡No dude en ponerse en contacto con nosotros! En MonsterGym
                  "The
                  Muscle Factory" nos importan mucho nuestros clientes, el
                  personal a cargo le responderá lo más pronto posible para
                  resolver sus dudas sobre el fitness, entrenamientos, precios
                  de
                  membresías y ofertas.
                </p>
                <p class="text-justify">Ubicado en la ciudad del eterno
                  calor</p>
                <p class="text-justify">
                  Miraflores II Etapa Piura - Piura - Castilla.
                </p>
                <p class="text-justify">Av. Luis Montero Mz. L Lote. 1-2
                  Urb.</p>
                <p class="text-justify">Teléfono: 983 917 650</p>
                <p class="text-justify">
                  Email:
                  <a
                    ...
                    class="text-light">info@montergym.com</a>
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="row gap-4 fontstwo">
            <div class="col-sm">
              <div class="card text-bg-dark">
                <img
                  src="../Imagenes/contac1.jpg"
                  class="card-img opacity-50"
                  alt="Imagen con texto motivacional" />
                <div class="card-img-overlay">
                  <br /><br /><br />
                  <h1 class="card-title fw-bold">LO ÚNICO</h1>
                  <br />
                  <h1 class="card-title fw-bold">QUE NECESITAS</h1>
                  <br />
                  <h1 class="card-title fw-bold text-danger">"ES VOLUNTAD"</h1>
                </div>
              </div>
            </div>
            <div class="col-sm">
              <img
                src="../Imagenes/contac3.jpg"
                alt="Otra imagen de contacto"
                class="img-fluid rounded" />
            </div>
          </div>
        </div>
